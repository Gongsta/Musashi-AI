...
Only needs to be run once. Assumes data was downloaded into the current directory, i.e. `perception-research/datasets/kaggle_traffic_sign
...
if __name__ == "__main__":
	...
	N = len(images)
	split_dataset(images, train_size=int(0.8 * N), val_size=int(0.1 * N)) # 80 10 10 train-val-test split, test size automatically inferred
